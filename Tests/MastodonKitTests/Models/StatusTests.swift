...
class StatusTests: XCTestCase {
    func testStatusWithNullFromJSON() throws {
        ...
        XCTAssertEqual(status.repliesCount, 69)
    }

    func testStatusWithoutNullFromJSON() throws {
        ...
        XCTAssertEqual(status.repliesCount, 420)
    }
